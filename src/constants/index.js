...
const experiences = [
  ...
  },
  {
    ...
    company_name: "Airbus Defence And Space, France",
    icon: airbus,
    iconBg: "#FFFFFF",
    date: "March 2024 - Sep 2024",
    points: [
      "Simplify the understanding and utilization of logs generated by the OneAtlas backend.",
      "Creation of relevant logs using Golang.",
      "Deployment of Filebeat and Logstash on Kubernetes in a GCP cluster using Helm templates.",
      "Initialization and configuration of RabbitMQ in the Kubernetes operator.",
      "Develop a monitoring service in Airbus projects to visualize the geoprocessing lifecycle in real-time.(Golang)",
      "Facilitate monitoring and anomaly detection through graphical representation.(Angular)",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
  },
];
